                ...
                <div class="bg-white/5 backdrop-blur-lg rounded-lg border border-purple-500/20 overflow-hidden">
                    ...
                    <div class="divide-y divide-purple-500/10">
                        @forelse($category->lessons as $lesson)
                            <a href="{{ route('lms.lesson', $lesson) }}" class="block px-6 py-4 hover:bg-purple-500/10 transition group">
                                <div class="flex items-start justify-between">
                                    <div class="flex-1">
                                        <h3 class="text-lg font-semibold text-white group-hover:text-purple-300 transition">{{ $lesson->title }}</h3>
