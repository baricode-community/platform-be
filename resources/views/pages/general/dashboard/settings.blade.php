    ...
    <section class="bg-white dark:bg-gradient-to-br dark:from-slate-900 dark:to-slate-800 min-h-screen py-8 md:py-12">
        <div class="max-w-5xl mx-auto px-4 md:px-8">
            ...
            <div class="mb-16 md:mb-20">
                <div class="mb-4">
                    <span class="text-slate-500 dark:text-slate-400 text-sm font-semibold uppercase tracking-wider">⚙️ Konfigurasi</span>
                </div>
                ...
                <p class="text-lg text-slate-600 dark:text-slate-300 max-w-2xl leading-relaxed">
                    Kelola preferensi akun dan tampilan platform Anda sesuai kebutuhan. Semua perubahan akan disimpan secara otomatis untuk memberikan pengalaman terbaik.
                </p>
            </div>
            ...
            <div class="space-y-12">
                ...
                <div class="animate-slideIn">
                    <div class="flex items-center gap-2 mb-6">
                        <div class="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-blue-100 dark:bg-blue-900/30">
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-8">
                        <p class="text-slate-600 dark:text-slate-300 mb-8">
                            Pilih tema tampilan yang paling nyaman untuk Anda. Tema akan menyesuaikan dengan preferensi sistem atau pilihan Anda secara manual.
                        </p>

                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <flux:radio.group x-data variant="segmented" x-model="$flux.appearance" class="grid grid-cols-3 w-full">
                        ...
                        <div class="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                            <p class="text-sm text-blue-900 dark:text-blue-200">
                                💡 <strong>Tips:</strong> Pilih "Sistem" untuk mengikuti preferensi perangkat Anda secara otomatis.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="animate-slideIn" style="animation-delay: 0.1s;">
                    <div class="flex items-center gap-2 mb-6">
                        <div class="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-purple-100 dark:bg-purple-900/30">
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-8">
                        <p class="text-slate-600 dark:text-slate-300 mb-8">
                            Lihat dan kelola informasi akun Anda. Untuk mengubah profil atau keamanan akun, kunjungi halaman profil.
                        </p>

                        <div class="space-y-4">
                            <a href="{{ route('profile', auth()->user()->username) }}" 
                               class="flex items-center justify-between p-6 bg-slate-50 dark:bg-slate-700/50 rounded-xl border border-slate-200 dark:border-slate-600 hover:border-purple-400 dark:hover:border-purple-500 transition-all duration-300 group">
                                <div class="flex items-center gap-4">
                                    <div class="inline-flex items-center justify-center w-12 h-12 rounded-lg bg-purple-100 dark:bg-purple-900/30 group-hover:bg-purple-200 dark:group-hover:bg-purple-900/50 transition-colors">
                                        <svg class="w-6 h-6 text-purple-600 dark:text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-slate-600 dark:text-slate-400">Kelola informasi pribadi dan foto profil</p>
                                    </div>
                                </div>
                                <svg class="w-5 h-5 text-slate-400 dark:text-slate-500 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="mt-6 p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-200 dark:border-purple-800">
                            <p class="text-sm text-purple-900 dark:text-purple-200">
                                👤 <strong>Informasi Akun:</strong> Anda masuk sebagai <span class="font-semibold">{{ auth()->user()->name }}</span>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="animate-slideIn" style="animation-delay: 0.2s;">
                    <div class="flex items-center gap-2 mb-6">
                        <div class="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-amber-100 dark:bg-amber-900/30">
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-8">
                        ...
                        <div class="mt-6 p-4 bg-amber-50 dark:bg-amber-900/20 rounded-lg border border-amber-200 dark:border-amber-800">
                            <p class="text-sm text-amber-900 dark:text-amber-200">
                                🔒 <strong>Catatan:</strong> Anda akan keluar dari sesi ini. Untuk alasan keamanan, Anda mungkin perlu login kembali.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="animate-slideIn" style="animation-delay: 0.3s;">
                    <div class="flex items-center gap-2 mb-6">
                        <div class="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-green-100 dark:bg-green-900/30">
