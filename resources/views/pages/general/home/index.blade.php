            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="bg-gradient-to-br from-purple-500/10 to-transparent backdrop-blur-lg rounded-3xl p-8 border border-purple-500/20 hover:border-purple-500/50 transition-all hover:shadow-xl hover:shadow-purple-500/20">
                        ...
                        <p class="text-gray-300 mb-4">Belajar sambil ketawa. Share meme coding favoritmu dengan komunitas.</p>
                        <a href="{{ route('memes') }}" class="inline-block px-6 py-2 bg-purple-600/80 text-white rounded-full font-semibold hover:bg-purple-700 transition-all">
                            Lihat Meme Coding
                        </a>
                    </div>
